...
* Line `5` creates a `fileInput` object with an `outputId` of `"fileInput"`. The title of this `fileInput` is `"Choose .txt file"`. Lastly, this `fileInput` will accept only `.txt` files.
